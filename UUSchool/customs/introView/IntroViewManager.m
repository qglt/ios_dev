...
- (void)showCustomIntro {
    ...
    CustomPage * cp1 = [[CustomPage alloc]initWithImage:@"IMG_0028.PNG" title:@"    " detail:@"    "];
    
    IntroPage *page1 = [IntroPage pageWithCustomView:cp1];
//    page1.bgImage = [UIImage imageNamed:@"introBg@2x.png"];
    
    CustomPage * cp2 = [[CustomPage alloc]initWithImage:@"IMG_0024.PNG" title:@"      App" detail:@"          \n TengrTal          "];
    IntroPage *page2 = [IntroPage pageWithCustomView:cp2];
//    page2.bgImage = [UIImage imageNamed:@"2.png"] ;
    
    CustomPage * cp3 = [[CustomPage alloc]initWithImage:@"IMG_0029.PNG" title:@"" detail:@"  www.ttcy.com   \n        "];
    IntroPage *page3 = [IntroPage pageWithCustomView:cp3];
//    page3.bgImage = [Utils createImageWithColor:[Utils colorWithHexString:@"#339cff"]];
